...
$ \frac{n_\text{e}}{t} = \frac{I_\text{p}A}{hf} = \frac{P}{E} \qquad i = \frac{n}{t} \cdot e = \frac{Q}{t} \qquad I = \frac{P}{A} \qquad \rho_{\text{ph}} = \frac{E_\text{ph}}{c} = \frac{h}{\lambda} \qquad E_n = n hf \\[+1mm]$
