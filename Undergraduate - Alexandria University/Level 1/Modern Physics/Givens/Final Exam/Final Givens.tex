...
\noindent
$
    K.E = \frac{\rho^2}{2m} \quad  \hslash = \frac{h}{2\pi}\quad  \mu = -(\frac{e}{2m})L\quad P.E_m = \sz \mu B\cos{\theta}\quad  \Delta\lambda = \frac{eB\lambda^2}{4\pi mc} \quad \Delta v = \frac{eB}{4\pi m}\\
    \quad  \\
